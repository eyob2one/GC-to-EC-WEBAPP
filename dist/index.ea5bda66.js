...
})({"24HDx":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "d312e5a1ea5bda66";
"use strict";
...
},{}],"5JdfA":[function(require,module,exports) {
// Assuming all necessary functions from ./main.js are imported correctly
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createEventListnersHTML", ()=>createEventListnersHTML);
...
function updateCalculatedEthDateOnPage() {
    ...
    const ethDate = (0, _mainJs.toEthiopianDateTime)(new Date(Date.UTC(eurYear, eurMonth - 1, eurDate)));
    ...
    const europeanDate = (0, _mainJs.toEuropeanDateString)(ethDate);
...
function updateCalculatedEurDateOnPage() {
    ...
    // Add validation for date input (e.g., ensure dates are within valid range)
    const ethDate = new (0, _mainJs.ethTime)(ethDate_Day, ethDate_Month, ethDate_Year, 0, 0, 0); // Assuming 'ethTime' constructor exists
    const europeanDate = (0, _mainJs.toEuropeanDate)(ethDate);
    document.getElementById("EuropeanDate").value = europeanDate.toJSON().slice(0, 10);
    document.getElementById("EurDayTextArea").innerHTML = (0, _mainJs.toEuropeanDateString)(ethDate);
    document.getElementById("ethDayTextArea").innerHTML = ethDate.dateWithDayString;
}
function initDates() {
...
var ethTodayTextArea = new Vue({
    ...
    methods: {
        refreshEthDateOnPage: function() {
            [this.ethTodayDateText, this.ethTodayTimeText] = (0, _mainJs.toEthiopianDateTimeString)(new Date());
        },
...
},{}]},["24HDx","5JdfA"], "5JdfA", "parcelRequire94c2")

//# sourceMappingURL=index.ea5bda66.js.map
